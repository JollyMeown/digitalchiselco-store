...
const GROUPS: string[][] = [
  ...
  ['deer', 'buck', 'stag', 'whitetail', 'antler', 'antlers', 'elk', 'ciervo', 'venado', 'veado', 'jelen', 'hirsch', 'sarna', 'reh'],
  ['fish', 'bass', 'trout', 'fishing', 'angler', 'salmon', 'marlin', 'pike', 'pesca', 'pescado', 'peixe', 'ryba', 'wedkarstwo', 'fisch'],
  ['duck', 'ducks', 'mallard', 'waterfowl', 'kaczka', 'kaczki', 'ente', 'enten'],
  ['boar', 'wild boar', 'hog', 'dzik', 'wildschwein', 'keiler', 'jabali'],
  ...
  ['owl', 'owls', 'sowa', 'eule'],
  ['lion', 'lions', 'leo'],
  ['jesus', 'christ', 'crucifix', 'cross', 'religious', 'christian', 'holy', 'jezus', 'jesucristo', 'cristo', 'cruz', 'krzyz', 'kreuz'],
  ['last supper', 'ostatnia wieczerza', 'letzte abendmahl', 'ultima cena', 'santa ceia', 'abendmahl'],
  ['stations of the cross', 'droga krzyzowa', 'via crucis', 'via sacra', 'estaciones de la cruz', 'kreuzweg'],
  ['mary', 'virgin mary', 'madonna', 'our lady', 'guadalupe', 'maryja', 'virgen', 'maria', 'matka boska', 'matka boza'],
  ['angel', 'angels', 'cherub', 'aniol', 'anioly', 'anjo', 'engel'],
  ...
  ['golf', 'golfer', 'golfing'],
  ['hunting', 'hunter', 'lodge', 'cabin', 'game', 'polowanie', 'mysliwskie', 'jagd', 'jager'],
