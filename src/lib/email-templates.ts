...
// (Free-pack file delivery is owned by the MailerLite welcome automation —
// see /free/confirm. We deliberately don't render a Resend version here so
// customers only ever receive one delivery email.)
